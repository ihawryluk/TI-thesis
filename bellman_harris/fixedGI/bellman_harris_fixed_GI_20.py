...
prediction_means_5 = prediction_means
# prediction_means_20 = prediction_means
# prediction_means_40 = prediction_means
# prediction_means_8 = prediction_means

predictions_df = pd.read_csv('predictions_cases.csv')
# predictions_df['cases'] = stan_data['cases']
# predictions_df['GI8'] = prediction_means_8
# predictions_df['GI20'] = prediction_means_20
# predictions_df['GI40'] = prediction_means_40
predictions_df['GI5'] = prediction_means_5
predictions_df.to_csv('predictions_cases.csv', index = False)

plt.plot(stan_data['x'], stan_data['cases'], label = 'data')
plt.plot(stan_data['x'], prediction_means_8, label = 'model, GI mean = 8', ls = ':')
plt.plot(stan_data['x'], prediction_means_20, label = 'model, GI mean = 20', ls = ':')
plt.plot(stan_data['x'], prediction_means_40, label = 'model, GI mean = 40', ls = ':')
plt.legend()
plt.xlabel('Days')
